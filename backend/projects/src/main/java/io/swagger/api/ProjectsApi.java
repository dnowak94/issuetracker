...
public interface ProjectsApi {
    ...
    ResponseEntity<Project> addProject(@Parameter(in = ParameterIn.DEFAULT, description = "Create a new project", required=true, schema=@Schema()) @Valid @RequestBody Project body
);


    @Operation(summary = "Create an issue for a project", description = "Create a new issue for a project", tags={ "issues" })
    @ApiResponses(value = { 
        ...
        @ApiResponse(responseCode = "405", description = "Invalid input") })
    @RequestMapping(value = "/projects/{projectId}/issues",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.POST)
    ResponseEntity<Issue> createIssue(@Parameter(in = ParameterIn.PATH, description = "ID of project to get issues from", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
...
, @Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Task body
    ...
    @RequestMapping(value = "/projects/{projectId}/issues/{issueId}",
        method = RequestMethod.DELETE)
    ResponseEntity<String> deleteIssue(@Parameter(in = ParameterIn.PATH, description = "ID of the issue that needs to be deleted", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
, @Parameter(in = ParameterIn.PATH, description = "ID of the issue that needs to be deleted", required=true, schema=@Schema()) @PathVariable("issueId") Long issueId
    ...
    @RequestMapping(value = "/projects/{projectId}/tasks/{taskId}",
        method = RequestMethod.DELETE)
    ResponseEntity<String> deleteTask(@Parameter(in = ParameterIn.PATH, description = "ID of the issue that needs to be deleted", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
, @Parameter(in = ParameterIn.PATH, description = "ID of the task that needs to be deleted", required=true, schema=@Schema()) @PathVariable("taskId") Long taskId
    ...
    @RequestMapping(value = "/projects/{projectId}",
        method = RequestMethod.DELETE)
    ResponseEntity<String> deleteproject(@Parameter(in = ParameterIn.PATH, description = "project id to delete", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
);
    ...
    @RequestMapping(value = "/projects/{projectId}/issues/{issueId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Issue> getIssue(@Parameter(in = ParameterIn.PATH, description = "ID of the project", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
...
, @Parameter(in = ParameterIn.QUERY, description = "can be used to filter by issue status" ,schema=@Schema()) @Valid @RequestParam(value = "status", required = false) String status
    ...
    @RequestMapping(value = "/projects/{projectId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Project> getProjectById(@Parameter(in = ParameterIn.PATH, description = "ID of project to return", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
);
    ...
    @RequestMapping(value = "/projects/{projectId}/tasks/{taskId}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Task> getTask(@Parameter(in = ParameterIn.PATH, description = "ID of the project", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
...
, @Parameter(in = ParameterIn.QUERY, description = "for filtering by task status" ,schema=@Schema()) @Valid @RequestParam(value = "status", required = false) String status
    ...
    ResponseEntity<Void> updateIssue(@Parameter(in = ParameterIn.PATH, description = "ID of the project", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
, @Parameter(in = ParameterIn.PATH, description = "ID of the issue", required=true, schema=@Schema()) @PathVariable("issueId") Long issueId
, @Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Issue body
);
    ...
    @RequestMapping(value = "/projects/{projectId}",
        consumes = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<Void> updateProjectWithForm(@Parameter(in = ParameterIn.PATH, description = "ID of project that needs to be updated", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
, @Parameter(in = ParameterIn.DEFAULT, description = "Updates a project", required=true, schema=@Schema()) @Valid @RequestBody Project body
    ...
    @RequestMapping(value = "/projects/{projectId}/tasks/{taskId}",
        ...
        consumes = { "application/json" }, 
        method = RequestMethod.PUT)
    ResponseEntity<Task> updateTask(@Parameter(in = ParameterIn.PATH, description = "ID of the project", required=true, schema=@Schema()) @PathVariable("projectId") Long projectId
, @Parameter(in = ParameterIn.PATH, description = "ID of the task", required=true, schema=@Schema()) @PathVariable("taskId") Long taskId
, @Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema()) @Valid @RequestBody Task body
);
